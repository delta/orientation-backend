...
func RoomBroadcast() {
	l := config.Log.WithFields(logrus.Fields{"method": "gorilla/RoomBroadcast"})
...
func (r *room) getRoomUsers() ([]string, error) {
	l := config.Log.WithFields(logrus.Fields{"method": "gorilla/getRoomUsers"})
...
func broadcastNewuser(user *user) {
	l := config.Log.WithFields(logrus.Fields{"method": "gorilla/broadcastNewuser"})
...
func broadcastUserleftRoom(userId int, leftRoom string) {
	l := config.Log.WithFields(logrus.Fields{"method": "gorilla/broadcastUserleftRoom"})
